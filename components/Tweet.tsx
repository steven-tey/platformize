...
export default function Tweet({id, metadata}) {
    ...
    return (
        ...
        <div className="border-t border-gray-300 pt-4 flex space-x-5 text-base !text-gray-700 dark:!text-gray-300 mt-2">
            <a
            className="flex items-center !text-gray-500 hover:!text-red-600 transition !no-underline"
            href={likeUrl}
            target="_blank"
            rel="noopener noreferrer"
            >
            ...
            <a
            className="flex items-center mr-4 !text-gray-500 hover:!text-green-600 transition !no-underline"
            href={retweetUrl}
            target="_blank"
            rel="noopener noreferrer"
            >
            ...
            <a
            className="flex items-center mr-4 !text-gray-500 hover:!text-blue-600 transition !no-underline"
            href={replyUrl}
            target="_blank"
            rel="noopener noreferrer"
            >
